...
public class FFVar {
    //Time
    public static float TransferATime = 0.5F;
    ...
    public static float InTransfer = 0.2F;
    ...
    public static float ArmWait = 0.2F;
    ...
    public static float WristTransfer = 0.19F;
    public static float WristOut = 0.7F;
    public static float WristWait = 0.4F;
    public static float WristTransfer2 = 0.25F;
